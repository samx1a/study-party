      ...
      <main className="mx-auto w-full max-w-3xl flex-1 px-4 py-10">
        ...
        {me.isAnonymous && (
          <div className="mt-4 flex flex-col items-start justify-between gap-3 rounded-xl bg-accent/60 px-4 py-3 text-sm text-accent-ink sm:flex-row sm:items-center">
            <p>You&apos;re a guest. Create a free account to keep your streak on any device.</p>
            <ButtonLink href="/sign-up?next=/dashboard" size="sm" variant="secondary">
              Save my progress
            </ButtonLink>
          </div>
        )}
              ...
              {rooms.map((r) => (
                <li key={r.id}>
                  ...
                  >
                    ...
                    <span className="shrink-0 text-sm font-medium text-accent-ink">Join</span>
                  </Link>
                </li>
              ))}
            </ul>
